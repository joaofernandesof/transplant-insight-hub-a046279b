...
-- Recreate single version with account_id lookup + default fallback
...
BEGIN
  ...
  -- Fallback by account_id (AI agent passes account_id as p_user_id)
  IF v_config IS NULL THEN
  ...
  -- If still no config, generate default slots (08:00-18:00, Mon-Sat)
  IF v_config IS NULL THEN
