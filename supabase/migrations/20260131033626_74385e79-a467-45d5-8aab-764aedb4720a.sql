-- Function to delete a lead and all related data
...
DECLARE
  ...
  v_lead_name TEXT;
BEGIN
  -- Get lead name for confirmation
  ...
  -- 1. Delete CRM messages (through conversations)
  ...
  -- 3. Delete WhatsApp contacts linked to lead
  DELETE FROM public.avivar_whatsapp_contacts WHERE crm_lead_id = p_lead_id;
  GET DIAGNOSTICS v_deleted_contacts = ROW_COUNT;

  -- 4. Delete patient journeys (by matching phone or name)
