...
type PortalKey = 'admin' | 'neocare' | 'neoteam' | 'neoacademy' | 'neolicense' | 'avivar' | 'hotleads' | 'main';
...
const PORTAL_CONFIG: Record<PortalKey, PortalConfig> = {
  ...
  neoacademy: { name: 'Conecta Capilar', color: 'text-blue-700', bgColor: 'bg-blue-100', headerBg: 'bg-gradient-to-r from-blue-900 to-blue-800', headerText: 'text-white', icon: GraduationCap, accentBorder: 'border-l-blue-500', accentBg: 'bg-blue-500' },
...
function detectPortal(pathname: string): PortalKey {
  ...
  if (pathname.startsWith('/neorh')) return 'neoteam'; // legacy redirect
