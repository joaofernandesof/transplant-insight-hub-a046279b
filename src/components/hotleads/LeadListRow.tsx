...
export function LeadListRow({
  ...
  return (
    <div className={`border-b border-border/40 hover:bg-muted/30 transition-colors border-l-2 ${accentColor}`}>
      {/* Desktop row */}
      <div className="hidden sm:flex items-center gap-3 px-3 py-2.5">
        ...
        <div className="flex items-center gap-1 text-xs text-muted-foreground w-[160px] shrink-0">
      ...
      {/* Mobile row - compact, no horizontal scroll */}
      <div className="flex sm:hidden items-start gap-2 px-3 py-2.5">
        <Checkbox
          checked={selected}
          onCheckedChange={() => onSelect?.(lead.id)}
