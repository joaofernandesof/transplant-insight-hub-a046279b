...
export const POST_SALE_STAGES: StageConfig[] = [
  ...
  // Retention stages merged into post-sale flow
  {
    ...
    blockingMessage: 'Registre o motivo do cancelamento para avançar',
    checklist: [
      { id: 'cancel_reason', label: 'Motivo do cancelamento registrado', field: 'cancellation_reason', required: true },
      { id: 'cancel_details', label: 'Detalhes da solicitação documentados', field: 'cancellation_details', required: false },
    ]
  },
  {
    id: 'analise_motivo',
    label: 'Análise do Motivo',
    description: 'Avaliação da causa da insatisfação',
    color: 'from-amber-500 to-amber-600',
    statusColor: 'bg-amber-500',
    blockingMessage: 'Registre a tentativa de retenção para avançar',
    checklist: [
      { id: 'retention_attempt', label: 'Tentativa de retenção realizada', field: 'retention_attempt_done', required: true },
      { id: 'retention_notes', label: 'Notas da negociação registradas', field: 'retention_attempt_notes', required: false },
    ]
  },
  {
    id: 'negociacao_retencao',
    label: 'Negociação',
    description: 'Negociação ativa com o paciente',
    color: 'from-orange-500 to-orange-600',
    statusColor: 'bg-orange-500',
    blockingMessage: 'Apresente uma oferta de retenção para avançar',
    checklist: [
      { id: 'offer_type', label: 'Tipo de oferta definido', field: 'retention_offer_type', required: true },
      { id: 'offer_details', label: 'Detalhes da oferta documentados', field: 'retention_offer_details', required: true },
    ]
  },
  {
    id: 'oferta_retencao',
    label: 'Oferta Apresentada',
    description: 'Oferta de retenção em análise pelo paciente',
    color: 'from-violet-500 to-violet-600',
    statusColor: 'bg-violet-500',
    blockingMessage: 'Registre a decisão final do paciente',
    checklist: [
      { id: 'offer_accepted', label: 'Resposta do paciente à oferta registrada', field: 'retention_offer_accepted', required: true },
    ]
  },
  {
    id: 'decisao_final',
    label: 'Decisão Final',
    description: 'Registro do desfecho',
    color: 'from-slate-500 to-slate-600',
    statusColor: 'bg-slate-500',
    blockingMessage: 'Registre a decisão final para encerrar',
    checklist: [
      { id: 'decision', label: 'Decisão final registrada (retido/não retido)', field: 'final_decision', required: true },
      { id: 'decision_notes', label: 'Justificativa da decisão', field: 'final_decision_notes', required: false },
    ]
  },
  {
    id: 'retido',
    label: 'Retido',
    description: 'Paciente retido com sucesso — retorna ao fluxo',
    color: 'from-emerald-500 to-emerald-600',
    statusColor: 'bg-emerald-500',
    blockingMessage: '',
    checklist: []
  },
  {
    id: 'nao_retido',
    label: 'Não Retido',
    description: 'Paciente não retido — chamado de distrato gerado',
