/**
 * Etapa Simplificada: Tipo de Atendimento (Presencial, Online, Domicílio)
 */
...
import { Building2, Monitor, CheckCircle2, Home, MapPin, Info } from 'lucide-react';
import { Alert, AlertDescription } from '@/components/ui/alert';

interface StepConsultationSimpleProps {
...
export function StepConsultationSimple({ 
  consultationType, 
  city, 
  state, 
  onChange,
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="max-w-xl mx-auto space-y-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3">
                  ...
                  />
                  <h4 className="font-semibold text-[hsl(var(--avivar-foreground))]">
                ...
                <p className="text-sm text-[hsl(var(--avivar-muted-foreground))] mt-1 ml-7">
                  {config.presencialDescription}
                </p>
                {city && state && (
                  <p className="text-xs text-[hsl(var(--avivar-primary))] mt-1 ml-7 flex items-center gap-1">
        ...
        {/* Info Alert */}
        {hasSelection && (consultationType.presencial && consultationType.online || 
         consultationType.presencial && consultationType.domicilio) && (
          <Alert className="bg-[hsl(var(--avivar-primary)/0.1)] border-[hsl(var(--avivar-primary)/0.3)]">
            ...
            <AlertDescription className="text-sm text-[hsl(var(--avivar-foreground))]">
              A IA priorizará a primeira opção, mas oferecerá outras quando solicitado pelo {terminology.cliente}.
            </AlertDescription>
          </Alert>
        )}
