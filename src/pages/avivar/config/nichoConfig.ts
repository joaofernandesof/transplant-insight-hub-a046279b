...
export const SERVICES_BY_SUBNICHO: Record<SubnichoType, Service[]> = {
  ...
  // IMOBILIÁRIO
  agente_imobiliario: [
    { id: 'venda_casas', name: 'Venda de Casas e Apartamentos', description: 'Intermediação de venda de imóveis residenciais', enabled: false },
    { id: 'venda_terrenos', name: 'Venda de Terrenos e Lotes', description: 'Intermediação de venda de terrenos e loteamentos', enabled: false },
    { id: 'venda_comercial', name: 'Venda de Galpões e Comerciais', description: 'Venda de galpões, salas comerciais e lojas', enabled: false },
    { id: 'aluguel_residencial', name: 'Aluguel Residencial', description: 'Locação de casas e apartamentos', enabled: false },
    { id: 'aluguel_comercial', name: 'Aluguel Comercial', description: 'Locação de salas, lojas e galpões', enabled: false },
    { id: 'compra_assessoria', name: 'Assessoria para Compradores', description: 'Consultoria para quem deseja comprar imóvel', enabled: false },
    { id: 'avaliacao', name: 'Avaliação de Imóveis', description: 'Avaliação de valor de mercado', enabled: false },
    { id: 'financiamento', name: 'Financiamento Imobiliário', description: 'Auxílio em financiamentos e documentação', enabled: false },
  ],
  imobiliaria: [
    { id: 'venda_residencial', name: 'Venda Residencial', description: 'Venda de casas e apartamentos', enabled: false },
    { id: 'venda_terrenos', name: 'Venda de Terrenos e Lotes', description: 'Venda de terrenos e loteamentos', enabled: false },
    { id: 'venda_comercial', name: 'Venda Comercial', description: 'Venda de galpões, salas e lojas', enabled: false },
    { id: 'aluguel_residencial', name: 'Aluguel Residencial', description: 'Locação de casas e apartamentos', enabled: false },
    { id: 'aluguel_comercial', name: 'Aluguel Comercial', description: 'Locação de salas, lojas e galpões', enabled: false },
    { id: 'lancamentos', name: 'Lançamentos', description: 'Imóveis na planta e pré-lançamento', enabled: false },
    { id: 'admin_locacao', name: 'Administração de Locação', description: 'Gestão de contratos de aluguel', enabled: false },
  ],
  construtora: [
    { id: 'casas', name: 'Casas Residenciais', description: 'Construção de casas sob medida', enabled: false },
    { id: 'apartamentos', name: 'Apartamentos', description: 'Empreendimentos de apartamentos', enabled: false },
    { id: 'galpoes_comercial', name: 'Galpões e Comerciais', description: 'Construção de galpões e imóveis comerciais', enabled: false },
    { id: 'loteamentos', name: 'Loteamentos', description: 'Desenvolvimento de loteamentos', enabled: false },
    { id: 'reforma', name: 'Reformas e Ampliações', description: 'Reformas residenciais e comerciais', enabled: false },
    { id: 'projeto', name: 'Projetos Personalizados', description: 'Elaboração de projetos sob medida', enabled: false },
  ],
  administradora: [
    { id: 'condominio', name: 'Administração de Condomínio', description: 'Gestão completa de condomínios', enabled: false },
    { id: 'locacao', name: 'Administração de Aluguéis', description: 'Gestão de contratos e cobranças de aluguel', enabled: false },
    { id: 'cobranca', name: 'Cobrança de Inadimplentes', description: 'Gestão de inadimplência condominial', enabled: false },
    { id: 'manutencao', name: 'Manutenção Predial', description: 'Manutenção preventiva e corretiva', enabled: false },
  ],
