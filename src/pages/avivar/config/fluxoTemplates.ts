  ...
  passosCronologicos: [
    {
      ...
      exemploMensagem:
        "Olá! Seja bem-vindo(a)!\n Eu sou a {atendente}, assistente virtual da {empresa}.\n Qual é o seu nome?",
    },
    {
      id: "identificacao e interesse",
      ordem: 2,
      titulo: "Identificação e Interesse",
      descricao:
        "Após receber o nome, agradeça e personalize a conversa usando o nome do lead. Identifique qual serviço ou procedimento o lead tem interesse. Pergunte de forma direta.",
      exemploMensagem: "Prazer, {nome}! Qual procedimento você gostaria de saber mais? {lista_servicos}",
    },
    {
      id: "qualificacao",
      ordem: 3,
      titulo: "Qualificação",
      descricao:
        "Faça perguntas para entender melhor a situação do lead: há quanto tempo tem o problema, já fez algum tratamento, expectativas.",
      exemploMensagem:
        "Para entender melhor seu caso: há quanto tempo você nota {problema}? Já fez algum tratamento antes?",
    },
    {
      id: "oferecer_datas",
      ordem: 4,
      ...
      descricao:
        'Use a técnica "ou/ou" - ofereça exatamente 2 opções de data e horário para facilitar a decisão e criar senso de escassez.',
    ...
    },
    {
      ...
      exemploMensagem:
        "Perfeito! Confirmando sua avaliação:\n\n📅 {data}\n⏰ {horario}\n📍 {endereco}\n\nPosso confirmar?",
    },
  ],
  passosExtras: [
    {
      ...
      exemploMensagem:
        "Vou te transferir para um de nossos especialistas que poderá te ajudar melhor. Aguarde um momento!",
    },
    {
      id: "reagendamento",
      ordem: 2,
      ...
      descricao:
        "Quando o lead precisar reagendar sua consulta. Verifique o agendamento atual, pergunte o motivo e ofereça novas datas disponíveis.",
      exemploMensagem:
        "Sem problemas, {nome}! Vou verificar sua consulta atual. Posso te oferecer {dia1} às {hora1} ou {dia2} às {hora2}. Qual fica melhor para você?",
    },
    {
      id: "cancelamento",
      ordem: 3,
      titulo: "Cancelamento",
      descricao:
        "Quando o lead quiser cancelar sua consulta. Tente entender o motivo, ofereça reagendamento como alternativa e, se confirmar o cancelamento, finalize com cordialidade.",
      exemploMensagem:
        "Entendo, {nome}. Posso saber o motivo do cancelamento? Se preferir, podemos reagendar para outra data que seja mais conveniente para você.",
    },
  ],
};
