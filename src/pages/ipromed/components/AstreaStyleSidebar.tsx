...
const mainNavItems: NavItem[] = [
  ...
  { id: 'templates', label: 'Templates', icon: FileText, href: '/ipromed/legal-hub?tab=templates' },
  ...
  { id: 'billing', label: 'Régua de Cobrança', icon: Bell, href: '/ipromed/legal-hub?tab=billing' },
  { id: 'timesheet', label: 'Timesheet', icon: LayoutGrid, href: '/ipromed/legal-hub?tab=timesheet', isNew: true },
  { id: 'ai', label: 'IA Jurídica', icon: Sparkles, href: '/ipromed/legal-hub?tab=ai', isNew: true },
  { id: 'tags', label: 'Etiquetas', icon: LayoutGrid, href: '/ipromed/legal-hub?tab=tags' },
