        ...
        <Card className="border-0 shadow-sm bg-gradient-to-br from-blue-50 to-blue-100">
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xs text-blue-700">Tempo Médio Resposta</div>
                <div className="text-2xl font-bold text-blue-800">18h</div>
        ...
        <Card className="border-0 shadow-sm bg-gradient-to-br from-emerald-50 to-emerald-100">
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xs text-emerald-700">SLA Cumprido</div>
                <div className="text-2xl font-bold text-emerald-800">94%</div>
                <div className="flex items-center text-xs text-emerald-600">
        ...
        <Card className="border-0 shadow-sm bg-gradient-to-br from-purple-50 to-purple-100">
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xs text-purple-700">Documentos Gerados</div>
        ...
        <Card className="border-0 shadow-sm bg-gradient-to-br from-amber-50 to-amber-100">
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xs text-amber-700">Prazos no Prazo</div>
        ...
        <Card className="border-0 shadow-sm bg-gradient-to-br from-rose-50 to-rose-100">
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xs text-rose-700">Alertas Pendentes</div>
                <div className="text-2xl font-bold text-rose-800">3</div>
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <Card className="border-0 shadow-lg">
          <CardHeader className="pb-2">
            <CardTitle className="text-lg">Compliance por Métrica</CardTitle>
          </CardHeader>
          <CardContent>
                ...
                <CardContent className="p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-xs text-muted-foreground">{attorney.role}</div>
                      ...
                      <div className="mt-3 space-y-2">
                        ...
                        <div className="grid grid-cols-2 gap-2 text-xs pt-2">
                          <div className="text-center p-2 bg-muted/50 rounded">
                            ...
                            <div className="text-muted-foreground">Casos Ativos</div>
                          </div>
                          <div className="text-center p-2 bg-muted/50 rounded">
