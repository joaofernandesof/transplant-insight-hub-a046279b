...
export default function ProcessCaseForm({ initialData, onSubmit, onCancel, isPending, isEdit }: Props) {
  ...
  const NATUREZA_OPTIONS = ['Cível', 'Trabalhista', 'Criminal', 'Administrativo', 'Tributário', 'Empresarial', 'Consumidor', 'Família e Sucessões', 'Previdenciário', 'Ambiental', 'Eleitoral', 'Constitucional', 'Saúde/Médico-Hospitalar', 'PEP', 'Sindicância'];
