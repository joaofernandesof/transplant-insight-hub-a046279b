...
export const journeyPhasesDetailed: PhaseDetail[] = [
  ...
  },
  {
    ...
    objective: 'Garantir que a reunião seja realizada conforme agendado e que o cliente receba o pacote jurídico completo.',
    duration: 'Até realização da reunião',
    deliverables: [
      'Reunião de apresentação confirmada',
      'Material de apresentação pronto',
      'Pacote jurídico completo entregue',
      'Orientação sobre uso dos documentos',
    ],
    actions: [
    ...
    checklist: [
      ...
      { id: 'c6', title: 'Orientação de uso realizada', required: true },
      { id: 'c7', title: 'NPS coletado', required: false },
    ],
    tips: [
