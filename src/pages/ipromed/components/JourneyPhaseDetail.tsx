...
export const journeyPhasesDetailed: PhaseDetail[] = [
  ...
  {
    id: 'Apresentacao',
    name: 'Pacote Jurídico Concluído - Agendar Reunião de Apresentação',
    label: 'Pacote Jurídico Concluído - Agendar Reunião de Apresentação',
    ...
    nextPhase: 'ReuniaoAgendada',
  },
  {
    id: 'ReuniaoAgendada',
    name: 'Reunião de Apresentação Agendada',
    label: 'Reunião de Apresentação Agendada',
    color: 'text-orange-600',
    bgColor: 'bg-orange-500',
    description: 'Reunião de apresentação do pacote jurídico agendada, aguardando realização.',
    objective: 'Garantir que a reunião seja realizada conforme agendado e que o cliente esteja preparado.',
    duration: 'Até realização da reunião',
    deliverables: [
      'Reunião de apresentação confirmada',
      'Material de apresentação pronto',
      'Cliente notificado sobre a reunião',
    ],
    actions: [
      { id: 'a1', title: 'Confirmar reunião', description: 'Enviar lembrete 24h antes da reunião', responsible: 'Equipe Jurídica', channel: 'call' },
      { id: 'a2', title: 'Preparar material final', description: 'Revisar apresentação e documentos para entrega', responsible: 'Advogado Responsável', channel: 'system' },
      { id: 'a3', title: 'Realizar reunião de apresentação', description: 'Conduzir reunião e entregar pacote jurídico', responsible: 'Advogado Responsável', channel: 'meeting' },
    ],
    checklist: [
      { id: 'c1', title: 'Reunião confirmada com cliente', required: true },
      { id: 'c2', title: 'Lembrete enviado 24h antes', required: true },
      { id: 'c3', title: 'Material de apresentação revisado', required: true },
      { id: 'c4', title: 'Reunião realizada', required: true },
      { id: 'c5', title: 'Pacote entregue ao cliente', required: true },
    ],
    tips: [
      'Confirme a reunião um dia antes',
      'Tenha backup de horário para reagendamento',
      'Prepare respostas para dúvidas frequentes',
    ],
    nextPhase: 'Continuo',
  },
  {
