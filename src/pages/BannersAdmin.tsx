...
import { 
  ...
  MousePointerClick, Image, ArrowLeft, ExternalLink
} from 'lucide-react';
          ...
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-6 py-4">
              ...
              <div className="grid gap-4">
                ...
                <div>
                  <Label htmlFor="bg_image_url">URL da imagem de fundo (opcional)</Label>
                  <Input
                    id="bg_image_url"
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    Se preenchido, a imagem substitui o gradiente de fundo
                  </p>
                </div>
