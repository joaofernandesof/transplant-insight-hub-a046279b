...
const tierColors: Record<string, string> = {
  ...
  titan: 'bg-emerald-100 text-emerald-700',
  legacy: 'bg-gradient-to-r from-amber-100 to-yellow-100 text-amber-700'
};
        ...
        <Card className="mb-8 bg-gradient-to-r from-primary/10 to-accent/10 border-primary/20">
          <CardContent className="py-8 text-center">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Conecte-se com outros licenciados, compartilhe experiências e cresça junto com a rede ByNeofolic.
              Aqui você encontra todos os membros da nossa comunidade.
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {filteredMembers.map((member) => {
              ...
              return (
                <Card 
                  key={member.id} 
                  className={`hover:shadow-lg transition-all ${isCurrentUser ? 'ring-2 ring-primary' : ''}`}
                >
