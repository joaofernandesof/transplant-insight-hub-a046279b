...
export default function PatientDashboard() {
  ...
  const quickActions = [
    ...
    { icon: Video, label: 'Teleconsulta', path: '/portal/teleconsultation', color: 'bg-green-500' },
    { icon: FileText, label: 'Meus Documentos', path: '/portal/my-records', color: 'bg-purple-500' },
    { icon: MessageSquare, label: 'Falar com a Clínica', path: '/portal/chat', color: 'bg-orange-500' },
  ];
    ...
    <div className="p-4 lg:p-8 space-y-6">
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <Button variant="outline" size="sm" onClick={() => navigate('/portal/appointments')}>
            Ver todos
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <Button variant="outline" size="sm" onClick={() => navigate('/portal/my-records')}>
            Ver todos
            <ArrowRight className="ml-2 h-4 w-4" />
          </Button>
        </CardHeader>
