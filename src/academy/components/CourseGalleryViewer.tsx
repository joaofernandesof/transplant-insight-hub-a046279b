    ...
    >
      <div className="relative aspect-video bg-muted overflow-hidden">
        {gallery.cover_photo_url ? (
          ...
          <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-emerald-100 to-emerald-200 dark:from-emerald-900 dark:to-emerald-800">
            <Images className="h-12 w-12 text-emerald-600 dark:text-emerald-400" />
          </div>
        )}
          ...
          {isLoading ? (
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 p-4">
              {photos.map((photo, index) => (
                <div
                  key={photo.id}
                  className="aspect-square rounded-lg overflow-hidden cursor-pointer hover:ring-2 ring-emerald-500 transition-all"
                  onClick={() => {
            ...
            <div className="relative flex items-center justify-center bg-black min-h-[60vh]">
              ...
              <img
                src={photos[currentIndex]?.full_url}
