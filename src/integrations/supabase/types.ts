  ...
  public: {
    Tables: {
      ...
      avivar_account_settings: {
        ...
        Relationships: [
          {
            foreignKeyName: "avivar_account_settings_account_id_fkey"
            columns: ["account_id"]
            isOneToOne: false
            referencedRelation: "avivar_accounts"
            referencedColumns: ["id"]
      ...
      hotlead_gamification_points: {
        ...
        Relationships: [
          {
            foreignKeyName: "hotlead_gamification_points_lead_id_fkey"
            columns: ["lead_id"]
            isOneToOne: false
            referencedRelation: "leads"
            referencedColumns: ["id"]
      ...
      neoteam_ticket_attachments: {
        ...
        Relationships: [
          {
            foreignKeyName: "neoteam_ticket_attachments_ticket_id_fkey"
            columns: ["ticket_id"]
            isOneToOne: false
            referencedRelation: "neoteam_tickets"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      user_portal_roles: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_portal_roles_portal_id_fkey"
            columns: ["portal_id"]
            isOneToOne: false
            referencedRelation: "portals"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "user_portal_roles_role_id_fkey"
            columns: ["role_id"]
            isOneToOne: false
            referencedRelation: "roles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "user_portal_roles_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "neohub_users"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      user_has_module_permission: {
        Args: { _action?: string; _auth_user_id: string; _module_code: string }
        Returns: boolean
      }
      user_has_permission: {
      ...
      user_has_portal_access: {
        Args: { _auth_user_id: string; _portal_slug: string }
        Returns: boolean
      }
